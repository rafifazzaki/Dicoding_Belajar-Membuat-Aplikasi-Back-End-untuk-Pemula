...
exports.up = pgm => {
    // untuk memitigasi user versi sebelumnya, sebelum ada authentication dan authorization kita membuat user baru khusus untuk mereka

    // membuat user baru
    pgm.sql("INSERT INTO users(id, username, password, fullname) VALUES ('old_notes', 'old_notes', 'old_notes', 'old_notes')")

    // mengubah nilai owner pada note dimana ownernya bernilai NULL
